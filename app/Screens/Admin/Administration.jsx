...
import FamiliesMap from "../AdministrationSection/map/map.jsx";
import UpdateProfileInfo from "../../UpdateForms/UpdateProfile.jsx";
  ...
  return (
    <>
      ...
      >
        ...
        <Stack.Screen options={slideFromRight} name="FamiliesMap">
          {(props) => <FamiliesMap {...props} drawer={navigation} />}
        </Stack.Screen>
        <Stack.Screen
          options={TransitionFromBottom}
          name="Family"
        ...
        <Stack.Screen options={slideFromRight} name="UpdateProfileInfo">
          {(props) => <UpdateProfileInfo {...props} drawer={navigation} />}
        </Stack.Screen>
